...
with open('jobs/emu_list_start_2.txt', 'r', encoding='utf-8') as file:
    for line in file:
        emu_name = line.strip()  # 移除行末的换行符
        emu_id = emu_name[4:] 
        os.system(f"\"C:/Program Files/Netease/MuMuPlayer-12.0/shell/MuMuManager.exe\" api -v {emu_id} launch_player")
        time.sleep(10)
time.sleep(45)
